    ...
    <div className='Dashboard'>
        <div className="btnSection">
            <div className="leftinput">
                <input type="text" placeholder="Enter text here" className='inputfield'/>
                <input type="text" placeholder="Enter text here" className='inputfield'/>
            </div>
            ...
            <div className="tableitems">
                {
                    data.map((items) => (
                        <div className="item">
                            <div className="item1 box">{items.Article }</div>
                            <div className="item2 box">{items.Product}</div>
                            <div className="item3 box">{items.InPrice}</div>
                            <div className="item4 box">{items.Price}</div>
                            <div className="item5 box">{items.Unit}</div>
                            <div className="item6 box">{items.InStock}</div>
                            <div className="item7 box">{items.Description}</div>
                        </div>
                    ))
                }
            </div>
